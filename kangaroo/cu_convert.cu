...
template void ConvertImage<unsigned char,float>(Image<unsigned char>, const Image<float>);
...
template void ConvertImage<float,uchar3>(Image<float>, const Image<uchar3>);
